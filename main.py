...
entry_red_name = tk.Entry(frame_red)
entry_red_city = tk.Entry(frame_red)
tree_red = ttk.Treeview(frame_red, columns=("Nazwa", "Miasto"), show='headings')
tree_red.heading("Nazwa", text="Nazwa")
tree_red.heading("Miasto", text="Miasto")
tree_red.pack(fill='both', expand=True)
tk.Label(frame_red, text="Nazwa:").pack()
entry_red_name.pack()
tk.Label(frame_red, text="Miasto:").pack()
entry_red_city.pack()
tk.Button(frame_red, text="Dodaj redakcję", command=add_redakcja).pack(pady=2)
tk.Button(frame_red, text="Aktualizuj redakcję", command=update_redakcja).pack(pady=2)
tk.Button(frame_red, text="Usuń redakcję", command=delete_redakcja).pack(pady=2)
tk.Button(frame_red, text="Pokaż szczegóły na mapie", command=show_selected_redakcja_on_map).pack(pady=5)

entry_prac_name = tk.Entry(frame_prac)
entry_prac_city = tk.Entry(frame_prac)
combo_prac_red = ttk.Combobox(frame_prac, state="readonly")
tree_prac = ttk.Treeview(frame_prac, columns=("Imię", "Miasto", "Redakcja"), show='headings')
tree_prac.heading("Imię", text="Imię i nazwisko")
tree_prac.heading("Miasto", text="Miasto")
tree_prac.heading("Redakcja", text="Redakcja")
tree_prac.pack(fill='both', expand=True)
tk.Label(frame_prac, text="Imię i nazwisko:").pack()
entry_prac_name.pack()
tk.Label(frame_prac, text="Miasto:").pack()
entry_prac_city.pack()
tk.Label(frame_prac, text="Redakcja:").pack()
combo_prac_red.pack()
tk.Button(frame_prac, text="Dodaj pracownika", command=add_pracownik).pack(pady=2)
tk.Button(frame_prac, text="Aktualizuj pracownika", command=update_pracownik).pack(pady=2)
tk.Button(frame_prac, text="Usuń pracownika", command=delete_pracownik).pack(pady=2)

entry_punkt_city = tk.Entry(frame_punkt)
combo_punkt_red = ttk.Combobox(frame_punkt, state="readonly")
tree_punkt = ttk.Treeview(frame_punkt, columns=("Miasto", "Redakcja"), show='headings')
tree_punkt.heading("Miasto", text="Miasto")
tree_punkt.heading("Redakcja", text="Redakcja")
tree_punkt.pack(fill='both', expand=True)
tk.Label(frame_punkt, text="Miasto:").pack()
entry_punkt_city.pack()
tk.Label(frame_punkt, text="Redakcja:").pack()
combo_punkt_red.pack()
